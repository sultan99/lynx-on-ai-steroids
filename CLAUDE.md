...
| `docs/architecture-diagram.md` | `/project diagram` |
| `src/app/routes/__route-tree.gen.ts` | TanStack Router (auto-generated) |
...
- `npm run emu` — Launch Android emulator (`Medium_Phone_API_36.1`)
